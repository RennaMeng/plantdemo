...
export function FeatureSelector({ selectedFeatures, onChange, onGenerate, onSave }: FeatureSelectorProps) {
  return (
    <section className="rounded-lg border border-archive-line bg-archive-label/85 p-5 shadow-specimen">
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-2">
        <button
          type="button"
          onClick={onGenerate}
          className="rounded-md border border-archive-ink bg-archive-ink px-4 py-3 text-sm font-medium text-white transition hover:bg-[#245037]"
        >
